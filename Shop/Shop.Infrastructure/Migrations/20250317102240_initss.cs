        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoData_MetaTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoData_MetaDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoData_MetaKeyWords = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoData_IndexPage = table.Column<bool>(type: "bit", nullable: false),
                    SeoData_Canonical = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Discount_DiscountTitle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondarySubCategoryId = table.Column<int>(type: "int", nullable: false),
                    Slug = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeoData_MetaTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoData_MetaDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoData_MetaKeyWords = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inventorys", x => new { x.SellerId, x.Id });
                    table.ForeignKey(
                        name: "FK_Inventorys_Sellers_SellerId",
                        column: x => x.SellerId,
